...
export const objectives: Objective[] = [
  {
    ...
    target: "50,000 créditos",
    description: "Ganar al menos 50,000 créditos en exportaciones netas de carga.",
    icon: "TrendingUp",
  },
  {
    id: "cargo-bounties",
  ...
  {
    id: "research-points",
    name: "Puntos de Investigación",
    department: "Ciencia",
    departmentColor: "#d381c9",
    target: "200,000 puntos",
    description: "Acumular al menos 200,000 puntos de investigación.",
    icon: "Microscope",
  },
  {
    id: "botany-harvest",
    name: "Cosecha de Botánica",
    department: "Civil",
  ...
  {
    id: "patient-recovery",
    name: "Recuperación de Pacientes",
    department: "Médico",
    departmentColor: "#52b4d9",
    target: "30 pacientes",
    description: "Curar al menos 30 pacientes del estado crítico.",
    icon: "HeartPulse",
  },
];
